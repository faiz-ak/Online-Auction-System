...
public class RecordClass {
 public record User(int user_id,String name,String email){}
...
public record  Transaction(int transaction_id,int item_id,int buyer_id,double amount,LocalDateTime transaction_time){}
}
